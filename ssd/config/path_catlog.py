...
class DatasetCatalog:
    DATA_DIR = "/share/kalanit/users/dfinzi/SSD/datasets"
    DATASETS = {
    ...
    def get(name):
        if "voc" in name:
            voc_root = os.path.join(DatasetCatalog.DATA_DIR, "VOC_ROOT")
            ...
            coco_root = os.path.join(DatasetCatalog.DATA_DIR, "COCO_ROOT")
